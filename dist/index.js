(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports,require('punycode')):typeof define==='function'&&define.amd?define(['exports','punycode'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f(g.gitInfo={},g.require$$0));})(this,(function(exports,require$$0){'use strict';function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var require$$0__default=/*#__PURE__*/_interopDefaultLegacy(require$$0);var hostedGitInfoFixed$1 = {exports: {}};var whatwgUrl = {};var webidl2jsWrapper = {};var URL$2 = {};var lib = {};(function (exports) {
...
})(lib);var utils$1 = {exports: {}};(function (module, exports) {
...
];var statusMapping = {};statusMapping.STATUS_MAPPING = {
  mapped: 1,
  valid: 2,
  disallowed: 3,
...
const extraUserinfoPercentEncodeSet = new Set([p$1("/"), p$1(":"), p$1(";"), p$1("="), p$1("@"), p$1("["), p$1("\\"), p$1("]"), p$1("^"), p$1("|")]);
...
var percentEncoding$1 = {
  ...
  URLStateMachine.prototype["parse path"] = function parsePath(c) {
    if (isNaN(c) || c === p("/") || isSpecial(this.url) && c === p("\\") || !this.stateOverride && (c === p("?") || c === p("#"))) {
      ...
      if (c === p("%") && (!infra$1.isASCIIHex(this.input[this.pointer + 1]) || !infra$1.isASCIIHex(this.input[this.pointer + 2]))) {
        this.parseError = true;
      }
...
_Function.convert = (globalObject, value, {
...
};var URLSearchParamsImpl = {};const urlencoded$1 = urlencoded$2;
...
})(URLSearchParams$3);const usm = urlStateMachine$1.exports;
...
URLImpl.implementation = class URLImpl {
  constructor(globalObject, constructorArgs) {
    ...
    this._query = URLSearchParams$2.createImpl(globalObject, [query], {
  ...
  const Impl = URLImpl;
})(URL$2);const URL$1 = URL$2;
const URLSearchParams$1 = URLSearchParams$3;
webidl2jsWrapper.URL = URL$1;
webidl2jsWrapper.URLSearchParams = URLSearchParams$1;const {
  URL,
  URLSearchParams
} = webidl2jsWrapper;
...
whatwgUrl.percentDecodeBytes = percentEncoding.percentDecodeBytes;function ownKeys(object, enumerableOnly) {
...
var gitHosts$2 = {};
gitHosts$2.github = Object.assign({}, defaults, {
...
gitHosts$2.bitbucket = Object.assign({}, defaults, {
...
gitHosts$2.gitlab = Object.assign({}, defaults, {
  protocols: ['git+ssh:', 'git+https:', 'ssh:', 'https:'],
  domain: 'gitlab.com',
  treepath: 'tree',
...
gitHosts$2.gist = Object.assign({}, defaults, {
...
var names = Object.keys(gitHosts$2);
gitHosts$2.byShortcut = {};
gitHosts$2.byDomain = {};

for (var _i = 0, _names = names; _i < _names.length; _i++) {
  var name = _names[_i];
  gitHosts$2.byShortcut["".concat(name, ":")] = name;
...
var gitHostInfo = gitHosts$2;var gitHosts$1 = gitHostInfo;

var GitHost$1 = /*#__PURE__*/function () {
  ...
  _createClass(GitHost, [{
    ...
    value: function _fill(template, opts) {
      if (typeof template === 'function') {
        var options = _objectSpread2(_objectSpread2(_objectSpread2({}, this), this.opts), opts); // the path should always be set so we don't end up with 'undefined' in urls
    ...
    value: function browse(path, fragment, opts) {
      ...
      return this._fill(this.browsefiletemplate, _objectSpread2(_objectSpread2({}, opts), {}, {
        fragment: fragment,
        path: path
      }));
    }
    ...
    value: function tarball(opts) {
      return this._fill(this.tarballtemplate, _objectSpread2(_objectSpread2({}, opts), {}, {
        noCommittish: false
      }));
    }
  }, {
    ...
    value: function file(path, opts) {
      return this._fill(this.filetemplate, _objectSpread2(_objectSpread2({}, opts), {}, {
        path: path
      }));
    }
  }, {
...
var gitHost = GitHost$1;var yallist = Yallist$1;
Yallist$1.Node = Node;
...
} catch (er) {}const Yallist = yallist;
...
var lruCache = LRUCache;var url = whatwgUrl;
var gitHosts = gitHostInfo;
var GitHost = hostedGitInfoFixed$1.exports = gitHost;
var LRU = lruCache;
var cache = new LRU({
  max: 1000
});
...
var fromUrl_1 = hostedGitInfoFixed$1.exports.fromUrl = function (giturl, opts) {
...
function fromUrl(giturl, opts) {
  ...
  var url = isGitHubShorthand(giturl) ? 'github:' + giturl : correctProtocol(giturl);
  ...
  try {
    if (gitHostShortcut) {
      ...
      var firstAt = pathname.indexOf('@'); // we ignore auth for shortcuts, so just trim it out
...
var correctProtocol = function correctProtocol(arg) {
...
var isGitHubShorthand = function isGitHubShorthand(arg) {
  ...
  var hasSlash = firstSlash > 0; // if a # is found, what we really want to know is that the character immediately before # is not a /
...
var correctUrl = function correctUrl(giturl) {
  var firstAt = giturl.indexOf('@');
  var lastHash = giturl.lastIndexOf('#');
  var firstColon = giturl.indexOf(':');
  var lastColon = giturl.lastIndexOf(':', lastHash > -1 ? lastHash : Infinity);
  var corrected;
  ...
  if (firstColon === -1 && giturl.indexOf('//') === -1) {
    ...
    corrected = "git+ssh://".concat(corrected);
  }
...
var parseGitUrl = function parseGitUrl(giturl) {
  var result;
  ...
  var correctedUrl = correctUrl(giturl);
...
var hostedGitInfoFixed = hostedGitInfoFixed$1.exports;exports["default"]=hostedGitInfoFixed;exports.fromUrl=fromUrl_1;Object.defineProperty(exports,'__esModule',{value:true});}));